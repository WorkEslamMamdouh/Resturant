...
namespace WebUl.API.Tools
{
    public class Shared
    {
        ...
        public static ResponseResult TransactionProcess(int CompCode,int BranchCode, int id, string type,SamahEntities _db)
        {
            ...
            try
            {
                ...
                //var ok = _db.G_ProcessTrans(CompCode, BranchCode, type, id, objParameterTrNo,objParameterOk);
