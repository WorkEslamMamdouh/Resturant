...
{//eslam 1 dec 2020
    public class PrintReportsController : Controller
    {
        ...
        string cs = "Data Source= . ; database = Resturant ; user id = sa ; Password= 619619 ;";
        ...
        private string BindReport(string reportName, int OutputTypeNo, string OutputType, ReportsDetails ReportsDetail, params object[] models)
        {
            ...
            try
            {
                ...
                byte[] renderedBytes; 
                renderedBytes = localReport.Render(reportType, "<DeviceInfo><OutputFormat>PNG</OutputFormat></DeviceInfo>"); 
