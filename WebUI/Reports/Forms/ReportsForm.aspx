...
<%--<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=15.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb"  %>--%>
...
<body dir="ltr">
   ...
   <%-- style="float:left!important"--%> <rsweb:ReportViewer ID="reportViewer1" Height="70%" Width="70%" runat="server"></rsweb:ReportViewer>
